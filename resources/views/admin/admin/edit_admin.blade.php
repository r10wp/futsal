...
@section('content')
  ...
  @foreach ($admins as $admin)
    <form class="" action="/editAdmin/{{ $admin->id }}" method="post"  enctype="multipart/form-data">
      @csrf
              ...
              <div class="form-horizontal">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="tlp" class="form-control" pattern="[0-9]+" value="{{ $admin->tlp }}" required>
                    </div>
                  </div>
                  <div class="form-group">
