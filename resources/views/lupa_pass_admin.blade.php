...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('asset_backend/plugins/iCheck/square/blue.css') }}">
  ...
  <div class="login-box-body">
    ...
    <form action="/lupa-password-admin" method="post">
      ...
      <div class="row">
        <!-- /.col -->
        <div class="col-xs-12">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Kirim Konfirmasi Lupa Password</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!-- iCheck -->
<script src="{{ asset('asset_backend/plugins/iCheck/icheck.min.js') }}"></script>
<script>
  $(function () {
    $('input').iCheck({
